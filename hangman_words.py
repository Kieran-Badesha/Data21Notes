word_list = ['Word', 'another', 'other', 'something', 'onomatopoeia', 'poetry', 'pineapple', 'bottle', 'treasure',
             'python', 'super', 'strawberry', 'potato', 'banana', 'woolly', 'foxes', 'orange', 'curtain', 'zigzag',
             'zugzwang', 'pudgy', 'abruptly', 'absurd', 'abyss', 'affix', 'askew', 'avenue', 'awkward', 'axiom',
